...
const channels = [
    { id: '_Zdd3kwDOBM', name: 'PRIMEIROS EXERCÍCIOS DE COSTURA PARA INICIANTES' },
    { id: '_Y4Ja5hlJ7Q', name: 'COMO FAZER ACABAMENTOS - COSTURA FRANCESA E INGLESA' },
    { id: 'e6hElXL-g1U', name: 'ACABAMENTO COM REVEL' },
    { id: 'jowzmFCwYjQ', name: 'Como Fazer o Molde e Costura- Bolso cargo - Bolso Fole'},
    { id: 'aDOPSklbzqI', name: 'Molde e Costura- Bolso Faca'},
    { id: 'oYW87lWxbMQ', name: 'MOLDE E COSTURA: BOLSO NA COSTURA' },
    { id: '94Ghq5tWZjA', name: 'Bolso com Vista Dupla Embutido - Molde e Costura' },
    { id: 'AE2sIvj--Qg', name: 'Vestido Fácil- Rápido - Kaftan de Manga Japonesa - Costura sem Molde # Iniciantes na Costura' },
    { id: 'MC5zf0StGH8', name: 'Como Fazer e Costurar Carcela de Camisa' },
    { id: 'woj6tywUYoM', name: 'Costura Para iniciantes - Tecidos Para Iniciar na Costura' },
    { id: 'uvxBqZnSdcg', name: 'Costura Para iniciantes - Acessórios Fundamentais Para iniciar Na Costura' },
    { id: 'dT4NGl6G6FQ', name: 'Como Costurar - Bolso com Zíper - Jonatas Verly' },
    { id: 'pmM_T7FqiM4', name: 'Como Costurar Bolso Embutido - Costura Para Iniciantes' },
{ id: 'tJS5QGLYCSE', name: '4 Dicas de Costuras Incríveis - Técnica de costura para iniciantes #1' },
];
